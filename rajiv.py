...
parser.add_option("-o", "--output_file",      help="output_file_name",                         action="store",      type="string", dest="output_file",  default="test.root")
...
parser.add_option("-j", "--jet_type",         help="jet type to study",                        action="store",      type="string", dest="jet_type",   default="AntiKt6LCTopo")
...
triggers = [
            ...
            ### L1
            ### L2
            #"L2_j75_a4TTem_ht100_j140_c4cchad",
            #"L2_j75_a4TTem_ht150_j140_c4cchad",
            #"L2_j75_a4TTem_ht200_j140_c4cchad",
            #"L2_j75_a4TTem_ht300_j140_c4cchad",
            ### EF
            # "EF_j145_a4tchad_ht500_L2FS", # No luminosity
            #"EF_j145_a4tchad_ht600_L2FS",
            #"EF_j145_a4tchad_ht700_L2FS",
            #"EF_j145_a4tchad_ht800_L2FS",
            # "EF_j170_a4tchad_ht500",     # No luminosity
            "EF_j170_a4tchad_ht600",
            "EF_j170_a4tchad_ht700",
            #"EF_j170_a4tchad_ht800",
            "EF_3j170_a4tchad_L1J75",
            "EF_3j180_a4tchad_L1J75",
            "EF_3j55_a4tchad_L2FS",
...
if RECALIBRATE:
    ...
    ROOT.gSystem.Load("ApplyJetCalibration-00-03-03/StandAlone/libApplyJetCalibration.so")
    ...
    JetCalibrationTool = ROOT.JetCalibrationTool("%s"%JET_TYPE.strip("Jets"),
                                                 "ApplyJetCalibration-00-03-03/data/CalibrationConfigs/JES_Full2012dataset_Preliminary_Jan13%s.config"%config_suffix,
...
jet_BCH_CORR_CELL = ROOT.std.vector( float )()
jet_emfrac = ROOT.std.vector( float )()
...
treeCopy._jet_BCH_CORR_CELL = jet_BCH_CORR_CELL
treeCopy._jet_emfrac = jet_emfrac
...
treeCopy.Branch( 'jet_BCH_CORR_CELL', jet_BCH_CORR_CELL)
treeCopy.Branch( 'jet_emfrac', jet_emfrac)
...
branch_vectors.append(jet_BCH_CORR_CELL)
branch_vectors.append(jet_emfrac)
...
if options.trigger:
    ...
    import TriggerEmulator as TE
    trigger_emulator = TE.TriggerEmulator(triggers,verbose=options.verbose)
...
for event in xrange(nevents):
    ...
    #rajiv
    #print "mu raw real val: %3.3f"%(mu)        
    #print "mu/1.11 real val: %3.3f"%(mu/1.11)        
    #print "mu for plotting: %3.3f"%JetCalibrationTool.MuForPlotting(mu)

    muplot = JetCalibrationTool.MuForPlotting(mu)
    ratio = mu/muplot
    #print "mu scale factor val: %3.3f"%ratio        
    ...
    for iJet in range(jet_n):          
        ...
        jet_BCH_CORR_CELL.push_back(chainReader.ReadBranch("jet_%s_%s"%(JET_TYPE,"BCH_CORR_CELL"))[iJet])
        jet_emfrac.push_back(chainReader.ReadBranch("jet_%s_%s"%(JET_TYPE,"emfrac"))[iJet])
